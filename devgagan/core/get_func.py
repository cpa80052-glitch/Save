...
class FileOperations:
    ...
    async def process_filename(self, file_path: str, user_id: int) -> str:
        ...
        rename_tag = self.db.get_user_data(user_id, "rename_tag", "༺⚡༻ 𝑫𝒊𝒗𝒚𝒂𝒏𝒔𝒉 𝒔𝒉𝒖𝒌𝒍𝒂 ༺⚡༻")
...
class SmartTelegramBot:
        ...
        try:
            ...
            if free_check == 1:
                ...
                reply_markup = InlineKeyboardMarkup([[
                    InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/Divyanshshukla7")
                ]])
    ...
    async def _parse_message_link(self, msg_link: str, offset: int, protected_channels: Set[int], sender: int, edit_id: int) -> Tuple[Optional[int], Optional[int]]:
        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat_id in protected_channels:
                await app.edit_message_text(sender, edit_id, "❌ This channel is protected by **༺⚡༻ 𝑫𝒊𝒗𝒚𝒂𝒏𝒔𝒉 𝒔𝒉𝒖𝒌𝒍𝒂 ༺⚡༻ **.")
                return None, None
    ...
    async def send_settings_panel(self, chat_id: int, user_id: int):
        ...
        buttons = [
            ...
            [Button.url("Report Issues", "https://t.me/+5H5tJB8hlJo2MjU1")]
        ]
