...
BOT_TOKEN = getenv("BOT_TOKEN", "8484917058:AAEleY9829_v8vyKo187mTFv-qiAdmxlf-Y")
...
LOG_GROUP = getenv("LOG_GROUP", "-1003599320037")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003599320037"))
