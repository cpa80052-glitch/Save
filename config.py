...
BOT_TOKEN = getenv("BOT_TOKEN", "7535216441:AAHm8FZ1JQ6BgAhMtPSDKTHqo-O5GCJe-aI")
...
LOG_GROUP = getenv("LOG_GROUP", "-1003268928688")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003268928688"))
